...
class CRM_Civicpd_Page_CPDIndividual extends CRM_Core_Page {
  function run() {
        ...
        $output	.= '<tr valign="top">
        			...
        			<tr valign="top">
        				<td><!-- put in buttons for add edit view -->
        					<a href="/civicrm/civicpd/editindividual?cid='.$contact_id.'&amp;action=update&amp;catid=' . $dao->id . '">View</a>
        					| <a href="/civicrm/civicpd/editindividual?cid='.$contact_id.'&amp;action=new&amp;catid=' . $dao->id . '">New</a>
						</td>
      				</tr>
      				<tr valign="top">
      					<td>&nbsp;</td>
